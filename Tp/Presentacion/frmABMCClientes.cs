    ...
    public partial class frmABMCClientes : Form
    {
        ...
        private void btnGuardarC_Click(object sender, EventArgs e)
        {
            if (ValidarDatos())
            {
                ...
                u.FechaNacimiento = Convert.ToDateTime(dtpFecha.Value);
        ...
        private void CargarCampos(int idUsuario)
        {
            ...
            if (tabla.Rows.Count > 0)
            {
                ...
                cboTipo.SelectedValue = tabla.Rows[0]["descripcion"];
                ...
                cboSexo.SelectedValue = tabla.Rows[0]["descripcionS"].ToString();
                cboBarrio.SelectedValue = tabla.Rows[0]["nombreBarrio"].ToString();
